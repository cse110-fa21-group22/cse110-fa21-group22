 ...
 * @version 1.0
 */
var FoodIngredientsMapProducts = function () {
  /**
   ...
   * @param upc {String} 
   */
  function FoodIngredientsMapProducts(id, title, upc) {
    _classCallCheck(this, FoodIngredientsMapProducts);
  ...
  _createClass(FoodIngredientsMapProducts, null, [{
    key: 'initialize',
  ...
  return FoodIngredientsMapProducts;
}();
