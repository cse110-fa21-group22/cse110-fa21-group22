...
var _InlineResponse20035MenuItems = require('./InlineResponse20035MenuItems');
 ...
 * @version 1.0
 */
var InlineResponse20035 = function () {
  /**
   ...
   */
  function InlineResponse20035(menuItems, totalMenuItems, type, offset, _number) {
  ...
  _createClass(InlineResponse20035, null, [{
    key: 'initialize',
    value: function initialize(obj, menuItems, totalMenuItems, type, offset, _number) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('menuItems')) {
          obj['menuItems'] = _ApiClient2.default.convertToType(data['menuItems'], [_InlineResponse20035MenuItems2.default]);
        }
        if (data.hasOwnProperty('totalMenuItems')) {
          obj['totalMenuItems'] = _ApiClient2.default.convertToType(data['totalMenuItems'], 'Number');
        }
