 ...
 * @version 1.0
 */
var RecipesParseIngredientsNutritionProperties = function () {
  /**
   ...
   * @param unit {String} 
   */
  function RecipesParseIngredientsNutritionProperties(name, amount, unit) {
    _classCallCheck(this, RecipesParseIngredientsNutritionProperties);

    RecipesParseIngredientsNutritionProperties.initialize(this, name, amount, unit);
  }
  ...
  _createClass(RecipesParseIngredientsNutritionProperties, null, [{
    key: 'initialize',
  ...
  return RecipesParseIngredientsNutritionProperties;
}();
