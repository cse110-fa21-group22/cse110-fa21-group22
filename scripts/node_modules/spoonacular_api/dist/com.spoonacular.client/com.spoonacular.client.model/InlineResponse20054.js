...
var _InlineResponse20054Videos = require('./InlineResponse20054Videos');
 ...
 * @version 1.0
 */
var InlineResponse20054 = function () {
  /**
   ...
   */
  function InlineResponse20054(videos, totalResults) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('videos')) {
          obj['videos'] = _ApiClient2.default.convertToType(data['videos'], [_InlineResponse20054Videos2.default]);
        }
