...
var _InlineResponse20041Value = require('./InlineResponse20041Value');
 ...
 * @version 1.0
 */
var InlineResponse20041Items = function () {
  /**
   ...
   * @param type {String} 
   */
  function InlineResponse20041Items(id, slot, position, type) {
    _classCallCheck(this, InlineResponse20041Items);
  ...
  _createClass(InlineResponse20041Items, null, [{
    key: 'initialize',
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('value')) {
          obj['value'] = _InlineResponse20041Value2.default.constructFromObject(data['value']);
        }
      }
      return obj;
    }
