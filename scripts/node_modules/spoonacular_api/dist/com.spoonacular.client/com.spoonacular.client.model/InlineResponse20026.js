 ...
 * @version 1.0
 */
var InlineResponse20026 = function () {
  /**
   ...
   */
  function InlineResponse20026(ingredient, substitutes, message) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('ingredient')) {
          obj['ingredient'] = _ApiClient2.default.convertToType(data['ingredient'], 'String');
        }
        if (data.hasOwnProperty('substitutes')) {
          obj['substitutes'] = _ApiClient2.default.convertToType(data['substitutes'], ['String']);
        }
