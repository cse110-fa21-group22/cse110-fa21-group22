 ...
 * @version 1.0
 */
var RecipesParseIngredientsNutritionCaloricBreakdown = function () {
  /**
   ...
   */
  function RecipesParseIngredientsNutritionCaloricBreakdown(percentProtein, percentFat, percentCarbs) {
    _classCallCheck(this, RecipesParseIngredientsNutritionCaloricBreakdown);

    RecipesParseIngredientsNutritionCaloricBreakdown.initialize(this, percentProtein, percentFat, percentCarbs);
  }
  ...
  _createClass(RecipesParseIngredientsNutritionCaloricBreakdown, null, [{
    key: 'initialize',
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('percentProtein')) {
          obj['percentProtein'] = _ApiClient2.default.convertToType(data['percentProtein'], 'Number');
        }
        if (data.hasOwnProperty('percentFat')) {
          obj['percentFat'] = _ApiClient2.default.convertToType(data['percentFat'], 'Number');
        }
        if (data.hasOwnProperty('percentCarbs')) {
          obj['percentCarbs'] = _ApiClient2.default.convertToType(data['percentCarbs'], 'Number');
        }
      }
      return obj;
    }
  ...
  return RecipesParseIngredientsNutritionCaloricBreakdown;
}();
...
RecipesParseIngredientsNutritionCaloricBreakdown.prototype['percentProtein'] = undefined;

/**
 * @member {Number} percentFat
 */
RecipesParseIngredientsNutritionCaloricBreakdown.prototype['percentFat'] = undefined;

/**
 * @member {Number} percentCarbs
 */
RecipesParseIngredientsNutritionCaloricBreakdown.prototype['percentCarbs'] = undefined;
