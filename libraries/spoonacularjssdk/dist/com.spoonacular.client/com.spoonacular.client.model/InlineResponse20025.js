...
var _InlineResponse20025Results = require('./InlineResponse20025Results');
 ...
 * @version 1.0
 */
var InlineResponse20025 = function () {
  /**
   ...
   */
  function InlineResponse20025(results, offset, _number, totalResults) {
  ...
  _createClass(InlineResponse20025, null, [{
    key: 'initialize',
    value: function initialize(obj, results, offset, _number, totalResults) {
      obj['results'] = results;
      obj['offset'] = offset;
      obj['number'] = _number;
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('results')) {
          obj['results'] = _ApiClient2.default.convertToType(data['results'], [_InlineResponse20025Results2.default]);
        }
