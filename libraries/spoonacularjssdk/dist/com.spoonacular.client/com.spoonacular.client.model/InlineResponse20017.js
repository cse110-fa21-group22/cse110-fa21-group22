 ...
 * @version 1.0
 */
var InlineResponse20017 = function () {
  /**
   ...
   */
  function InlineResponse20017(cuisine, cuisines, confidence) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('cuisine')) {
          obj['cuisine'] = _ApiClient2.default.convertToType(data['cuisine'], 'String');
        }
        if (data.hasOwnProperty('cuisines')) {
          obj['cuisines'] = _ApiClient2.default.convertToType(data['cuisines'], ['String']);
        }
        if (data.hasOwnProperty('confidence')) {
          obj['confidence'] = _ApiClient2.default.convertToType(data['confidence'], 'Number');
        }
      }
      return obj;
    }
