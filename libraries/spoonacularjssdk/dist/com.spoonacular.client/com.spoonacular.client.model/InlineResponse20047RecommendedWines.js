 ...
 * @version 1.0
 */
var InlineResponse20047RecommendedWines = function () {
  /**
   ...
   * @param score {Number} 
   */
  function InlineResponse20047RecommendedWines(id, title, averageRating, description, imageUrl, link, price, ratingCount, score) {
    _classCallCheck(this, InlineResponse20047RecommendedWines);

    InlineResponse20047RecommendedWines.initialize(this, id, title, averageRating, description, imageUrl, link, price, ratingCount, score);
  }
  ...
  _createClass(InlineResponse20047RecommendedWines, null, [{
    key: 'initialize',
  ...
  return InlineResponse20047RecommendedWines;
}();
