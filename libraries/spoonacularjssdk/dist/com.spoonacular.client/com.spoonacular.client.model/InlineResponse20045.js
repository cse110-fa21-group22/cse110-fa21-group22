...
var _InlineResponse20045ProductMatches = require('./InlineResponse20045ProductMatches');
 ...
 * @version 1.0
 */
var InlineResponse20045 = function () {
  /**
   ...
   */
  function InlineResponse20045(pairedWines, pairingText, productMatches) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('productMatches')) {
          obj['productMatches'] = _ApiClient2.default.convertToType(data['productMatches'], [_InlineResponse20045ProductMatches2.default]);
        }
      }
      return obj;
    }
