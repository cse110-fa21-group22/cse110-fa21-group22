 ...
 * @version 1.0
 */
var InlineResponse20056 = function () {
  /**
   ...
   */
  function InlineResponse20056(answerText, media) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('answerText')) {
          obj['answerText'] = _ApiClient2.default.convertToType(data['answerText'], 'String');
        }
        if (data.hasOwnProperty('media')) {
          obj['media'] = _ApiClient2.default.convertToType(data['media'], [Object]);
        }
      }
      return obj;
    }
