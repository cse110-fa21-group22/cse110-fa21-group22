 ...
 * @version 1.0
 */
var InlineResponse20012 = function () {
  /**
   ...
   */
  function InlineResponse20012(calories, carbs, fat, protein, bad, good) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('calories')) {
          obj['calories'] = _ApiClient2.default.convertToType(data['calories'], 'String');
        }
        ...
        if (data.hasOwnProperty('bad')) {
          obj['bad'] = _ApiClient2.default.convertToType(data['bad'], [Object]);
        }
        if (data.hasOwnProperty('good')) {
          obj['good'] = _ApiClient2.default.convertToType(data['good'], [Object]);
        }
      }
      return obj;
    }
