 ...
 * @version 1.0
 */
var InlineResponse20023Ingredients = function () {
  /**
   ...
   */
  function InlineResponse20023Ingredients(id, original, glycemicIndex, glycemicLoad) {
    _classCallCheck(this, InlineResponse20023Ingredients);
  ...
  _createClass(InlineResponse20023Ingredients, null, [{
    key: 'initialize',
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('glycemicIndex')) {
          obj['glycemicIndex'] = _ApiClient2.default.convertToType(data['glycemicIndex'], 'Number');
        }
        if (data.hasOwnProperty('glycemicLoad')) {
          obj['glycemicLoad'] = _ApiClient2.default.convertToType(data['glycemicLoad'], 'Number');
        }
      }
      return obj;
    }
  ...
  return InlineResponse20023Ingredients;
}();
