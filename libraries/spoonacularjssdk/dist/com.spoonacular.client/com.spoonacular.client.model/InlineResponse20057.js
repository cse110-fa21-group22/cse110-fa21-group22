...
var _InlineResponse20057Suggests = require('./InlineResponse20057Suggests');
 ...
 * @version 1.0
 */
var InlineResponse20057 = function () {
  /**
   ...
   */
  function InlineResponse20057(suggests, words) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('suggests')) {
          obj['suggests'] = _InlineResponse20057Suggests2.default.constructFromObject(data['suggests']);
        }
        if (data.hasOwnProperty('words')) {
          obj['words'] = _ApiClient2.default.convertToType(data['words'], [Object]);
        }
      }
      return obj;
    }
