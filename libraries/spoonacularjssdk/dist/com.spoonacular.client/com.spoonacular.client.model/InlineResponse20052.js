 ...
 * @version 1.0
 */
var InlineResponse20052 = function () {
  /**
   ...
   */
  function InlineResponse20052(articles, groceryProducts, menuItems, recipes) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('Articles')) {
          obj['Articles'] = _ApiClient2.default.convertToType(data['Articles'], [Object]);
        }
        if (data.hasOwnProperty('Grocery Products')) {
          obj['Grocery Products'] = _ApiClient2.default.convertToType(data['Grocery Products'], [Object]);
        }
        if (data.hasOwnProperty('Menu Items')) {
          obj['Menu Items'] = _ApiClient2.default.convertToType(data['Menu Items'], [Object]);
        }
        if (data.hasOwnProperty('Recipes')) {
          obj['Recipes'] = _ApiClient2.default.convertToType(data['Recipes'], [Object]);
        }
      }
      return obj;
    }
