 ...
 * @version 1.0
 */
var InlineResponse20054Videos = function () {
  /**
   ...
   */
  function InlineResponse20054Videos(title, length, rating, shortTitle, thumbnail, views, youTubeId) {
    _classCallCheck(this, InlineResponse20054Videos);
  ...
  _createClass(InlineResponse20054Videos, null, [{
    key: 'initialize',
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('shortTitle')) {
          obj['shortTitle'] = _ApiClient2.default.convertToType(data['shortTitle'], 'String');
        }
        ...
        if (data.hasOwnProperty('youTubeId')) {
          obj['youTubeId'] = _ApiClient2.default.convertToType(data['youTubeId'], 'String');
        }
      }
      return obj;
    }
  ...
  return InlineResponse20054Videos;
}();
