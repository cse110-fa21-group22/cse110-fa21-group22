...
var _InlineResponse20013Ingredients = require('./InlineResponse20013Ingredients');
 ...
 * @version 1.0
 */
var InlineResponse20013Steps = function () {
  /**
   ...
   * @param step {String} 
   */
  function InlineResponse20013Steps(_number, step) {
    _classCallCheck(this, InlineResponse20013Steps);
  ...
  _createClass(InlineResponse20013Steps, null, [{
    key: 'initialize',
    value: function initialize(obj, _number, step) {
      obj['number'] = _number;
      obj['step'] = step;
    }
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('step')) {
          obj['step'] = _ApiClient2.default.convertToType(data['step'], 'String');
        }
  ...
  return InlineResponse20013Steps;
}();
