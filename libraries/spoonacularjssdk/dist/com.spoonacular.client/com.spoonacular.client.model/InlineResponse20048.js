 ...
 * @version 1.0
 */
var InlineResponse20048 = function () {
  /**
   ...
   */
  function InlineResponse20048(category, probability) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('probability')) {
          obj['probability'] = _ApiClient2.default.convertToType(data['probability'], 'Number');
        }
      }
      return obj;
    }
