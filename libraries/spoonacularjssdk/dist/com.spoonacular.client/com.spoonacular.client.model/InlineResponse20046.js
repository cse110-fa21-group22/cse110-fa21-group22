 ...
 * @version 1.0
 */
var InlineResponse20046 = function () {
  /**
   ...
   */
  function InlineResponse20046(wineDescription) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('wineDescription')) {
          obj['wineDescription'] = _ApiClient2.default.convertToType(data['wineDescription'], 'String');
        }
      }
      return obj;
    }
