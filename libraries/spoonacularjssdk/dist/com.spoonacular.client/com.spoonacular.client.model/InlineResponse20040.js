...
var _InlineResponse20040Items = require('./InlineResponse20040Items');
 ...
 * @version 1.0
 */
var InlineResponse20040 = function () {
  /**
   ...
   */
  function InlineResponse20040(name, items, publishAsPublic) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('items')) {
          obj['items'] = _ApiClient2.default.convertToType(data['items'], [_InlineResponse20040Items2.default]);
        }
        if (data.hasOwnProperty('publishAsPublic')) {
          obj['publishAsPublic'] = _ApiClient2.default.convertToType(data['publishAsPublic'], 'Boolean');
        }
      }
      return obj;
    }
